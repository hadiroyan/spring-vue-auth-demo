                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="text-right hidden sm:block">
                            <p class="text-sm font-medium text-gray-800">Firstname + Lastname</p>
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex justify-between bg-white p-6 mb-6 rounded-xl shadow-lg">
                <div class="flex items-center gap-4 p-4">
                    ...
                    <div>
                        <h2 class="font-semibold text-gray-800">Fullname</h2>
                        <h3 class="text-gray-600">email.mail@mail.com</h3>
                    </div>
                </div>
